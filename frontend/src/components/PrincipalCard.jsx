...
import { principalContactInfo } from "../data/data";
      ...
      <div className="flex justify-center items-center md:m-10 mx-3 my-10 ">
        <div className="flex lg:flex-row flex-col lg:gap-4 gap-10 p-4 bg-gray-100 items-center justify-between w-[90vw] rounded-2xl max-w-5xl">
          ...
          <div className="flex flex-col lg:w-[60%] w-full gap-2">
            ...
            <p className="text-md font-normal ">{principalContactInfo.name}</p>
            <p className="text-sm font-normal text-gray-600">
              ...
              country has successfully leveraged its engineering skills to build
              a formidable manufacturing sector. The continued improvement in
              industrial infrastructure coupled with favourable policies and
              thrust from the Government are expected to help sustain the growth
