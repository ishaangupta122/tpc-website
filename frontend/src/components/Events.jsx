		...
		<section id="events" className="py-20 bg-gradient-to-b from-gray-50 to-white">
			<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
				...
				<div className="text-center mb-16">
					...
					<div className="w-20 h-1 bg-blue-600 mx-auto rounded-lg"></div>
				</div>
							...
							return (
								<div
									...
									<div className={`w-full md:w-1/2 ${index % 2 === 0 ? 'md:pl-8' : 'md:pr-8'}`}>
										<div className={`p-6 rounded-lg shadow-lg border-t-4 ${colorClasses.border}`}>
											<div className={`${colorClasses.text} text-sm font-semibold mb-2`}>
												{event.date}
											</div>
											<h3 className="text-gray-800 text-xl font-bold mb-2">{event.title}</h3>
											...
											<button
												className={`mt-4 ${colorClasses.bg} ${colorClasses.hover} text-white px-4 py-2 rounded-lg text-sm font-medium`}>
												{event.buttonText}
											</button>
										</div>
									</div>
									<div className="hidden md:block absolute left-1/2 transform -translate-x-1/2 w-7 h-7 rounded-full bg-gray-300 border-4 border-gray-50"></div>
								</div>
							);
						})}
					</div>
				...
				<div className="text-center mt-16">
					<button className="bg-blue-600 hover:bg-blue-700 text-white font-bold py-3 px-8 rounded-lg flex items-center mx-auto ">
