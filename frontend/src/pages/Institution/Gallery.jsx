...
const GallerySection = () => {
	...
	const handlePageChange = (direction) => {
		...
		window.scrollTo({
			top: galleryRef.current ? galleryRef.current.offsetTop : 0,
			behavior: 'smooth',
		});
	};
	...
	return (
		<>
			<HeroSection imageUrl="./rec_gate.jpg" title="College Gallery" breadcrumbs={breadcrumbs} />
						...
						<div className={`grid  grid-cols-3 gap-2`}>
							{paginatedImages.map((img, index) => (
								<div
									...
									onClick={() => handlePreview(index + (currentPage - 1) * imagesPerPage)}>
									<img
										src={img}
