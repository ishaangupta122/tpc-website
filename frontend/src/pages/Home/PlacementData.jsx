const PlacementsData = () => {
	return (
		<div className="relative w-full lg:h-64 md:h-[70vh] h-[90vh] ">
			...
			<div className="relative h-full flex items-center justify-center">
				<div className="w-full flex space-y-10 lg:justify-between lg:space-y-0 flex-wrap lg:flex-nowrap px-4 md:px-12 max-w-6xl">
