		...
		<div className="flex justify-center items-center ">
			<div className="p-6 px-4 sm:px-14 my-10 max-w-7xl w-full">
				<div className="mb-6 space-y-6">
					<h2 className="text-2xl font-bold text-gray-800">College Placements</h2>
										...
										<tbody className="divide-y divide-gray-200">
											{departments.map((dept) => (
												<tr key={`${year}-${dept.department}`} className="hover:bg-gray-50">
													...
													<td className="px-6 py-4 text-sm text-gray-500">{dept.approvedIntake}</td>
													<td className="px-6 py-4 text-sm text-gray-500">
														{dept.companiesVisited}
													</td>
													<td className="px-6 py-4 text-sm text-gray-500">{dept.studentsPlaced}</td>
													<td className="px-6 py-4 text-sm text-gray-500">
														₹ {dept.avgPackage} LPA
													</td>
												</tr>
