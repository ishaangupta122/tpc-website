			...
			<div className="max-w-7xl mx-auto px-4 py-12 lg:px-8">
							...
							<div className="flex flex-col">
								...
								<div className="p-6 md:p-8">
									...
									<div className="space-y-4 text-gray-600 text-md">
										<p>
											Welcome to our department, where innovation meets education. We are committed
											to providing cutting-edge research opportunities and world-class education to
											our students. Our faculty members are leaders in their respective fields,
											ensuring that our students receive the highest quality education and
											mentorship.
										</p>
										<p>
											With state-of-the-art facilities and a robust curriculum, we prepare our
											students for successful careers in industry and academia.
										</p>
									</div>
								</div>
							</div>
				...
				<div className="bg-gray-50 border border-gray-300 rounded-lg shadow-lg max-w-3xl my-20">
					...
					<div className="relative px-6 py-4">
						...
						/>
						<div className="p-2">
							<h2 className="text-2xl font-semibold text-green-800">Dr. John Smith</h2>
							...
							<h2 className="font-light text-gray-700 mt-4 text-justify">
								...
								facilis eos inventore ratione adipisci laboriosam aspernatur! Beatae vero odit
								consequatur est nostrum fugiat reprehenderit velit et nobis. Quia fuga, ea sed, quod
								ducimus sunt doloremque quas quibusdam vero porro laudantium recusandae quis facilis
								ut corrupti amet natus!
							</h2>
						</div>
					</div>
				</div>
...
export default ArchitecturalDepartment;
