  ...
  const handleDelete = async (id) => {
    try {
      ...
      setFacultyList((prevList) =>
        prevList.filter((faculty) => faculty._id !== id)
      );
    } catch (error) {
              ...
              <div className='pl-6 pr-6 pb-6'>
                ...
                <div className='mt-4'>
                  <input
                    ...
                    required
                    className='w-full px-4 py-2 border border-neutral-300 rounded-lg focus:outline-none focus:border-blue-500'></input>
                </div>
                <div className='mt-4'>
                  <select
                    name='department'
                ...
                <div className='mt-4'>
                  <textarea
                    ...
                    required
                    className='w-full px-4 py-2 border border-neutral-300 rounded-lg focus:outline-none focus:border-blue-500'></textarea>
                </div>
                <div className='mt-4'>
                  <input
                    type='date'
